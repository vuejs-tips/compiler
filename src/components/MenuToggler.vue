<template>
  <svg class="inline-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="24px" height="30px" viewBox="0 0 24 30" enable-background="new 0 0 32 22.5" xml:space="preserve">
    <g class="svg-menu-toggle">
      ...
      <rect width="24" height="30" fill="none"></rect><!-- needs to be here as a 'hit area' -->
    </g>
  </svg>
</template>
